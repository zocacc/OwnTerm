...
- `session-trust-required-v1`: `{ version: 1, sessionId, destination, port, algorithm, fingerprint }`, sem segredo.
- `session-credential-required-v1`: `{ version: 1, sessionId, kind }`, sem transportar o valor secreto.
